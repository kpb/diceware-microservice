 ...
 *
 * <em>Note</em>: the creator of diceware recommends that you DO NOT use software to create a
 * passphrase, which is exactly what we are doing here. He also mentions Java's SecureRandom is good
 * enough to use.
 */
public class NumberGenerator {
  ...
  /**
   * Throw the dice, returning an integer between 1 and 6.
   *
   * @return
   */
  Integer throwDice() {
  ...
  public Set<Integer> generate(int num) {
    ...
    if (num < 3 || num > 10) {
      throw new IllegalArgumentException("Can only generate between 3 & 10 diceware numbers");
    }
